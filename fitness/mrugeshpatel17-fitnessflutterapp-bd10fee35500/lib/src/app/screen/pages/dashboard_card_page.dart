...
class DashBoardCardPage extends StatefulWidget {
  ...
  @override
  _DashBoardCardPageState createState() =>
      _DashBoardCardPageState(patientsData!);
}
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(11.0),
                          child: Text(healthText, style: tabbarTextStyle),
                        )),
                  ],
                ),
              ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              assetCircleImage(
                                  imageName: monitoringModeIconPng),
                              SizedBox(
                                width: 10,
                              ),
                              Text(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              assetCircleImage(
                                  imageName: managePastRecordingIconPng),
                              SizedBox(
                                width: 10,
                              ),
                              Text(
                                managePastRecordingText,
                                style: cardTextStyle,
                              )
                            ],
                          ),
