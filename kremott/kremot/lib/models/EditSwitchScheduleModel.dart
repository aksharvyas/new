/// schedule : {"applicationId":"string","Id":8,"homeId":"3F1C3A93-4D2E-40A2-B013-07D33B3BC18D","roomId":"57E5EA2F-A985-4F09-97BD-19ED300B49AA","scheduleStartDate":"2023-01-04T07:25:58.416Z","scheduleTime":"2023-01-04T07:25:58.416Z","scheduleRepeat":0,"onEverySunday":true,"onEveryMonday":true,"onEveryTuesday":true,"onEveryWednesday":true,"onEveryThursday":true,"onEveryFriday":true,"onEverySaturday":true,"scheduleName":"11:30Schedule","sceneId":"3fa85f64-5717-4562-b3fc-2c963f66afa6","individualAction":true,"UpdatedBy":"3fa85f64-5717-4562-b3fc-2c963f66afa6","UpdatedDateTime":"2023-01-16T11:03:31.293Z"}
/// switches : [{"Id":1,"roomCmacDetailId":1,"onOffStatus":"off"}]

class RequestEditSwitchSchedule {
  EditSwitchSchedule? _schedule;
  List<EditSwitches>? _switches;

  EditSwitchSchedule? get schedule => _schedule;
  List<EditSwitches>? get switches => _switches;

  RequestEditSwitchSchedule({
    EditSwitchSchedule? schedule,
    List<EditSwitches>? switches}){
    _schedule = schedule;
    _switches = switches;
  }

  RequestEditSwitchSchedule.fromJson(dynamic json) {
    _schedule = json["schedule"] != null ? EditSwitchSchedule.fromJson(json["schedule"]) : null;
    if (json["switches"] != null) {
      _switches = [];
      json["switches"].forEach((v) {
        _switches?.add(EditSwitches.fromJson(v));
      });
    }
  }
...
class EditSwitches {
  ...
  EditSwitches.fromJson(dynamic json) {
    _id = json["Id"];
...
/// scheduleName : "11:30Schedule"
/// sceneId : "3fa85f64-5717-4562-b3fc-2c963f66afa6"
/// individualAction : true
/// UpdatedBy : "3fa85f64-5717-4562-b3fc-2c963f66afa6"
/// UpdatedDateTime : "2023-01-16T11:03:31.293Z"

class EditSwitchSchedule {
  ...
  EditSwitchSchedule.fromJson(dynamic json) {
...
class ResponseEditSwitchSchedule {
  Value? _value;
  ...
  ResponseEditSwitchSchedule.fromJson(dynamic json) {
