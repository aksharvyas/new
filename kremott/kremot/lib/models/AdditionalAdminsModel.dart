...
class RequestAdditionalAdmins {
  ...
  RequestAdditionalAdmins.fromJson(dynamic json) {
...
class ResponseAdditionalAdmins {
  Value? _value;
  ...
  ResponseAdditionalAdmins.fromJson(dynamic json) {
...
class Value {
  List<AdditionalAdminAccessPermissions>? _appUserAccessPermissions;
  Meta? _meta;

  List<AdditionalAdminAccessPermissions>? get appUserAccessPermissions => _appUserAccessPermissions;
  Meta? get meta => _meta;

  Value({
    List<AdditionalAdminAccessPermissions>? appUserAccessPermissions,
    Meta? meta}){
  ...
  Value.fromJson(dynamic json) {
    if (json["appUserAccessPermissions"] != null) {
      ...
      json["appUserAccessPermissions"].forEach((v) {
        _appUserAccessPermissions?.add(AdditionalAdminAccessPermissions.fromJson(v));
      });
    }
...
class AdditionalAdminAccessPermissions {
  String? _appUserID;
  String? _userName;
  ...
  AdditionalAdminAccessPermissions({
    String? appUserID,
    String? userName}){
    _appUserID = appUserID;
    _userName = userName;
  ...
  AdditionalAdminAccessPermissions.fromJson(dynamic json) {
    _appUserID = json["appUserID"];
