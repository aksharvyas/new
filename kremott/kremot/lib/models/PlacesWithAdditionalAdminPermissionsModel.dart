...
class RequestPlacesWithAdditionalAdminPermissions {
  ...
  RequestPlacesWithAdditionalAdminPermissions.fromJson(dynamic json) {
...
/// value : {"appUserAccessPermissions":[{"appUserId":"7e8f46f6-4e62-4250-92ad-8ceffbf91903","homeName":"Home1","homeId":"e9ed268e-0c93-4407-8ca0-2ea424b7d611","isOwner":false,"isAdditionalAdmin":true,"isAdditionalUser":false,"createdDateTime":"2022-11-15T12:12:27","permissionGivenBy":"08a6bde6-2fc4-47c7-a141-d76dbcb4c4b4","permissionId":107}],"meta":{"message":"success.","status":"success","code":1}}
/// formatters : []
/// contentTypes : []
/// declaredType : null
/// statusCode : 200

class ResponsePlacesWithAdditionalAdminPermissions {
  Value? _value;
  ...
  ResponsePlacesWithAdditionalAdminPermissions({
    Value? value,
  ...
  ResponsePlacesWithAdditionalAdminPermissions.fromJson(dynamic json) {
...
/// appUserAccessPermissions : [{"appUserId":"7e8f46f6-4e62-4250-92ad-8ceffbf91903","homeName":"Home1","homeId":"e9ed268e-0c93-4407-8ca0-2ea424b7d611","isOwner":false,"isAdditionalAdmin":true,"isAdditionalUser":false,"createdDateTime":"2022-11-15T12:12:27","permissionGivenBy":"08a6bde6-2fc4-47c7-a141-d76dbcb4c4b4","permissionId":107}]
/// meta : {"message":"success.","status":"success","code":1}

class Value {
  List<AppUserAccessAdditionalAdminPermissions>? _appUserAccessPermissions;
  Meta? _meta;

  List<AppUserAccessAdditionalAdminPermissions>? get appUserAccessPermissions => _appUserAccessPermissions;
  Meta? get meta => _meta;

  Value({
    List<AppUserAccessAdditionalAdminPermissions>? appUserAccessPermissions,
    Meta? meta}){
  ...
  Value.fromJson(dynamic json) {
    if (json["appUserAccessPermissions"] != null) {
      ...
      json["appUserAccessPermissions"].forEach((v) {
        _appUserAccessPermissions?.add(AppUserAccessAdditionalAdminPermissions.fromJson(v));
      });
    }
...
class AppUserAccessAdditionalAdminPermissions {
  String? _appUserId;
  String? _homeName;
  String? _homeId;
  bool? _isOwner;
  ...
  AppUserAccessAdditionalAdminPermissions({
    String? appUserId,
    String? homeName,
    String? homeId,
    bool? isOwner,
  ...
  AppUserAccessAdditionalAdminPermissions.fromJson(dynamic json) {
    _appUserId = json["appUserId"];
