...
class HomePageSTBRemote extends StatefulWidget {
  double screenWidth;
  double screenHeight;
  HomePageSTBRemote(this.screenWidth, this.screenHeight, {Key? key}) : super(key: key);

  @override
  State<HomePageSTBRemote> createState() => _HomePageSTBRemoteState();
}

class _HomePageSTBRemoteState extends State<HomePageSTBRemote> {
              ...
              child: Stack(
                children: [
                  ...
                  Positioned.fill(
                      ...
                      child: Text(
                        "3. POINT IR CONTROLLER TOWARDS STB THEN PRESS POWER BUTTON MAKE SURE STB RESPONDS.",
                        maxLines: 2,
                  ...
                  Positioned(
                      ...
                      child: Text(
                        "5. PAIRED REMOTE WILL BE SAVE IN STB REMOTE.",
                        style: TextStyle(
                            //fontFamily: "Inter",
                            fontSize: getAdaptiveTextSize(
                                context, remoteDescTextSize),
                  ...
                  Positioned.fill(
                      ...
                      child: Text(
                        "6. IF THAN AUTOMATICALLY IT WILL SHIFT TO NEXT REMOTE OR YOU CAN SELECT ANOTHER REMOTE FROM ABOVE STB REMOTE NO. THEN TRY NEXT REMOTE",
                        maxLines: 3,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                            //fontFamily: "Inter",
