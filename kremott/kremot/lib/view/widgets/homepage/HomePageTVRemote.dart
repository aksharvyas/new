...
class HomePageTVRemote extends StatefulWidget {
  double screenWidth;
  double screenHeight;
  HomePageTVRemote(this.screenWidth, this.screenHeight, {Key? key}) : super(key: key);

  @override
  State<HomePageTVRemote> createState() => _HomePageTVRemoteState();
}

class _HomePageTVRemoteState extends State<HomePageTVRemote> {
              ...
              child: Stack(
                children: [
                  ...
                  Positioned.fill(
                      ...
                      child: Text(
                        "3. POINT IR CONTROLLER TOWARDS TV THEN PRESS POWER BUTTON MAKE SURE TV RESPONDS.",
                        maxLines: 2,
                  ...
                  Positioned(
                      ...
                      child: Text(
                        "5. PAIRED REMOTE WILL BE SAVE IN TV REMOTE.",
                        style: TextStyle(
                            //fontFamily: "Inter",
                            fontSize: getAdaptiveTextSize(
                                context, remoteDescTextSize),
                  ...
                  Positioned.fill(
                      ...
                      child: Text(
                        "6. IF THAN AUTOMATICALLY IT WILL SHIFT TO NEXT REMOTE OR YOU CAN SELECT ANOTHER REMOTE FROM ABOVE TV REMOTE NO. THEN TRY NEXT REMOTE",
                        maxLines: 3,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                            //fontFamily: "Inter",
