...
void createChangeAdminDialog(BuildContext context, double height, double width) {
      ...
      builder: (BuildContext context, void Function(void Function()) setState) {
        return Center(
          child: CustomDialog(
              ...
              Stack(
                children: [
                  DialogTitle(20.57, 31.85, "CHANGE ADMIN", 12.0, "Roboto"),
                  ...
                  Positioned(
                    ...
                    child: DialogCenterButton(
                        "CHANGE\nADMIN", 83.28, 36.17, optionsButtonTextSize, (selected) async {
      ...
      return Center(
        child: CustomDialog(
            ...
            Stack(
              children: [
                DialogTitle(
                    20.57, 31.85, "CHANGE ADMIN", 12.0, "Roboto"),
...
void selectPlaceChangeAdminDialog(BuildContext context, double height,
