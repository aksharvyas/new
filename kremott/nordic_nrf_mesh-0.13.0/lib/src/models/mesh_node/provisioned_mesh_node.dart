...
class ProvisionedMeshNode {
  ...
  /// Will return the unicast address of this node as stored in the local database
  Future<int> get companyIdentifier async => (await _methodChannel.invokeMethod<int>('companyIdentifier'))!;

  /// Will return the unicast address of this node as stored in the local database
  Future<int> get productIdentifier async => (await _methodChannel.invokeMethod<int>('productIdentifier'))!;

  Future<int> get versionIdentifier async => (await _methodChannel.invokeMethod<int>('versionIdentifier'))!;
